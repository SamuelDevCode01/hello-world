...
import { useMovimentosEstoque } from "@/hooks/use-operacao-leituras";
import { useMovimentarEstoque, useProdutos, type Produto } from "@/hooks/use-operacao";
...
function unidadeExibida(unidade: string) {
  return /^\d+(?:[.,]\d+)?$/.test(unidade.trim()) ? "un" : unidade;
}
