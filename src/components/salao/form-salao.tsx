...
export const esquemaSalao = z.object({
  ...
  cor_primaria: z.string().regex(/^#[0-9a-fA-F]{6}$/, "Use um código de cor como #C1622D"),
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input className="h-12 rounded-xl" placeholder="Ex.: Studio Bella" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
            ...
            <FormItem>
              ...
              <FormControl>
                <Input
                  ...
                  placeholder="Quem cuida do salão"
                  {...field}
                  value={field.value ?? ""}
                />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Intervalo da agenda (minutos)</FormLabel>
              <FormControl>
                <Input type="number" min={5} max={240} step={5} className="h-12 rounded-xl" {...field} />
              </FormControl>
              <FormDescription>De quanto em quanto tempo os horários aparecem.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        ...
        {!compacto && (
          <>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Logo (endereço da imagem)</FormLabel>
                  <FormControl>
                    <Input
                      className="h-12 rounded-xl"
                      placeholder="https://..."
